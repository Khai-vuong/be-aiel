...
async function createLogs(prisma: PrismaClient): Promise<void> {
  const logs = [
    ...
    ['log002', 'upload_file', 'File', 'fabcd', 'user002', '2024-01-10T08:15:00Z'],
    ['log003', 'upload_file', 'File', 'fbcde', 'user002', '2024-01-10T08:20:00Z'],
    ['log004', 'create_quiz', 'Quiz', 'qabcd', 'user002', '2024-01-12T14:30:00Z'],
    ['log005', 'create_quiz', 'Quiz', 'qbcde', 'user002', '2024-01-14T10:00:00Z'],
    ['log006', 'create_quiz', 'Quiz', 'qcdef', 'user002', '2024-01-18T09:30:00Z'],
    ['log007', 'create_quiz', 'Quiz', 'qdefg', 'user002', '2024-01-25T11:00:00Z'],
    ['log008', 'create_quiz', 'Quiz', 'qefgh', 'user002', '2024-02-01T13:45:00Z'],
    ['log009', 'login', 'User', 'user004', 'user004', '2024-01-15T20:00:00Z'],
    ['log010', 'create_attempt', 'Attempt', 'aabcd', 'user004', '2024-01-16T10:00:00Z'],
    ['log011', 'submit_attempt', 'Attempt', 'aabcd', 'user004', '2024-01-16T10:30:00Z'],
    ['log012', 'update_attempt', 'Attempt', 'aabcd', 'user002', '2024-01-16T15:00:00Z'],
    ...
    ['log016', 'download_file', 'File', 'fabcd', 'user004', '2024-01-17T09:15:00Z'],
    ['log017', 'download_file', 'File', 'fbcde', 'user004', '2024-01-17T09:18:00Z'],
    ['log018', 'update_class', 'Class', 'class001', 'user002', '2024-01-18T07:45:00Z'],
    ['log019', 'grade_attempt', 'Attempt', 'aabcd', 'user002', '2024-01-18T08:15:00Z'],
    ['log020', 'view_results', 'Attempt', 'aabcd', 'user004', '2024-01-18T09:00:00Z'],
    ...
    ['log027', 'post_quiz_results', 'Quiz', 'qabcd', 'user002', '2024-01-21T10:00:00Z'],
